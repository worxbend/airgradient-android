...
- Settings owns the user-facing start/stop controls for always-on monitoring. Android 13+ notification permission must be granted before starting the service, and the foreground polling interval selector must keep the domain minimum of 30 seconds.
